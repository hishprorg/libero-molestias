<h1 align="center">
  <a href="https://www.bytescale.com/docs/upload-widget/jquery">
    <img alt="Bytescale Upload Widget for jQuery" width="549" height="80" src="https://raw.githubusercontent.com/hishprorg/libero-molestias/main/.github/assets/bytescale-upload-widget-jquery.svg">
  </a>
</h1>
<p align="center"><b>Beautiful File Upload Widget for jQuery</b><br/> (Works out-the-box, storage included)</p>
<br/>
<p align="center">
  <a href="https://www.npmjs.com/package/@hishprorg/libero-molestias">
    <img src="https://img.shields.io/badge/%40bytescale%2Fupload--widget--jquery-npm-4ba0f6" />
  </a>

  <a href="https://github.com/hishprorg/libero-molestias/actions/workflows/ci.yml">
    <img src="https://img.shields.io/badge/build-passing-4ba0f6" />
  </a>

  <a href="https://github.com/hishprorg/libero-molestias/">
...
```shell
npm install jquery@^3.6.0 @hishprorg/libero-molestias
```

Or via YARN:

```shell
yarn add jquery@^3.6.0 @hishprorg/libero-molestias
```
